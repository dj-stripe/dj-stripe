...
class TestSubscriberModelRetrievalMethod(TestCase):
    ...
    @override_settings(STRIPE_SECRET_KEY="sk_live_foo", STRIPE_LIVE_MODE=True)
    def test_global_secret_key_live_mode(self):
    ...
    @override_settings(STRIPE_SECRET_KEY="sk_test_foo", STRIPE_LIVE_MODE=False)
    def test_global_secret_key_test_mode(self):
        reload(djstripe_settings)
    ...
    def test_secret_key_live_mode(self):
