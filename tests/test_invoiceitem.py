...
class InvoiceItemTest(CreateAccountMixin, AssertStripeFksMixin, TestCase):
    # Beyond the suite-wide COMMON_BLANK_FKS allowlist, InvoiceItem syncs
    # commonly leave Invoice.payment_intent / PaymentIntent.invoice unset
    # because the InvoiceItem fixture has no PaymentIntent attached.
    ...
    def test_sync_proration(self):
        ...
        self.assert_fks(
            invoiceitem,
            expected_blank_fks={"djstripe.InvoiceItem.subscription"},
        )
