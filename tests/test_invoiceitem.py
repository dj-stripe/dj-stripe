...
from tests import FAKE_INVOICEITEM, FAKE_INVOICE_II, FAKE_CHARGE_II, FAKE_CUSTOMER_II
...
class InvoiceItemTest(TestCase):
    ...
    def setUp(self, invoice_retrieve_mock, charge_retrieve_mock, customer_retrieve_mock, default_account_mock):
