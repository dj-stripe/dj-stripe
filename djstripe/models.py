...
class StripeObject(models.Model):
    ...
    description = StripeTextField(stripe_required=False, help_text="A description of this object.")
...
class Charge(StripeObject):
    ...
    * **source_transfer** - #
    ...
    transfer_group = StripeCharField(
        max_length=255, stripe_required=False,
...
class Customer(StripeObject):
    ...
    * **discount** - #
    ...
    business_vat_id = StripeCharField(
        max_length=20, stripe_required=False,
    ...
    shipping = StripeJSONField(
        stripe_required=False, help_text="Shipping information associated with the customer."
    )
...
class Source(StripeObject):
    ...
    code_verification = StripeJSONField(
        stripe_required=False, help_text=(
...
class Transfer(StripeObject):
    ...
    * **reversals** - #
    ...
    destination_type = StripeCharField(
        stripe_name="type", max_length=14, stripe_required=False,
        help_text="The type of the transfer destination."
    )
    failure_code = StripeEnumField(
        enum=enums.PayoutFailureCode, stripe_required=False,
        help_text="Error code explaining reason for transfer failure if available. "
        "See https://stripe.com/docs/api/python#transfer_failures."
    )
    failure_message = StripeTextField(
    ...
    status = StripeEnumField(
        enum=enums.PayoutStatus, stripe_required=False,
