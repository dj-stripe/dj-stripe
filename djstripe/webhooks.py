...
def handler(event_types):
    ...
    Is used for the specified event types (e.g. 'customer') or fully qualified event sub-types
...
def handler_all(func=None):
    """
    Decorator which registers a function as a webhook handler for ALL webhook events.
