...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'djstripe_subscription', (
            ...
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'subscriptions', null=True, to=orm['djstripe.Customer'])),
        ...
        db.send_create_signal(u'djstripe', ['Subscription'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'djstripe_subscription')
