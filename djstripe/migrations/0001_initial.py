    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decline_charge_on', djstripe.fields.StripeJSONField(help_text='Account-level settings to automatically decline certain types of charges regardless of the decision of the card issuer', null=True, blank=True)),
                ...
                ('legal_entity', djstripe.fields.StripeJSONField(help_text='Information about the legal entity itself, including about the associated account representative', null=True, blank=True)),
                ('payout_schedule', djstripe.fields.StripeJSONField(help_text='Details on when funds from charges are available, and when they are paid out to an external account.', null=True, blank=True)),
                ...
                ('tos_acceptance', djstripe.fields.StripeJSONField(help_text='Details on the acceptance of the Stripe Services Agreement', null=True, blank=True)),
                ('verification', djstripe.fields.StripeJSONField(help_text='Information on the verification state of the account, including what information is needed and by when', null=True, blank=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fee_details', djstripe.fields.StripeJSONField(null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tiers', djstripe.fields.StripeJSONField(help_text='Each element represents a pricing tier. This parameter requires `billing_scheme` to be set to `tiered`.', null=True, blank=True)),
                ...
                ('transform_usage', djstripe.fields.StripeJSONField(help_text='Apply a transformation to the reported usage or set quantity before computing the billed price. Cannot be combined with `tiers`.', null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('package_dimensions', djstripe.fields.StripeJSONField(help_text='The dimensions of this product for shipping purposes. A SKU associated with this product can override this value by having its own `package_dimensions`. Only applicable to products of `type=good`.', null=True, blank=True)),
