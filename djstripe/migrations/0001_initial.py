    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_primary_color', djstripe.fields.StripeCharField(help_text='A CSS hex color value representing the primary branding color for this account', max_length=7, null=True, blank=True)),
                ...
                ('payout_statement_descriptor', djstripe.fields.StripeCharField(default='', help_text='The text that appears on the bank account statement for payouts.', max_length=255, null=True, blank=True)),
                ('payouts_enabled', models.BooleanField(help_text='Whether Stripe can send payouts to this account')),
                ('product_description', djstripe.fields.StripeCharField(help_text='Internal-only description of the product sold or service provided by the business. It’s used by Stripe for risk and underwriting purposes.', max_length=255, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hosted_invoice_url', djstripe.fields.StripeCharField(help_text='The URL for the hosted invoice page, which allows customers to view and pay an invoice. If the invoice has not been frozen yet, this will be null.', max_length=799, null=True, blank=True)),
                ('invoice_pdf', djstripe.fields.StripeCharField(help_text='The link to download the PDF for the invoice. If the invoice has not been frozen yet, this will be null.', max_length=799, null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', djstripe.fields.StripeCharField(help_text='A brief description of the plan, hidden from customers.', max_length=5000, null=True, blank=True)),
