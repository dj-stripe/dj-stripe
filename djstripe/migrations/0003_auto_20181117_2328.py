    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("djstripe_created", models.DateTimeField(auto_now_add=True)),
                ("djstripe_updated", models.DateTimeField(auto_now=True)),
                ("amount", djstripe.fields.StripeQuantumCurrencyAmountField(help_text="Amount earned.")),
                ("amount_refunded", djstripe.fields.StripeQuantumCurrencyAmountField(help_text="Amount refunded (can be less than the amount attribute on the fee if a partial refund was issued)")),
                ("currency", djstripe.fields.StripeCurrencyCodeField(help_text="Three-letter ISO currency code", max_length=3)),
                ("refunded", models.BooleanField(help_text="Whether the fee has been fully refunded. If the fee is only partially refunded, this attribute will still be false.")),
                ...
                ("charge", models.ForeignKey(help_text="The charge that the application fee was taken from.", on_delete=django.db.models.deletion.CASCADE, to="djstripe.Charge")),
            ],
            options={
                "get_latest_by": "created",
                "abstract": False,
