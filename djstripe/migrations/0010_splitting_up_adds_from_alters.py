...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # Original format is a charge stripe id.... renaming it and creating a new field. The sync in the next migration will take care of filling the charge field.
        ...
        migrations.AddField(
            model_name='subscription',
            name='plan',
            field=models.ForeignKey(related_name='subscriptions', default=1, to='djstripe.Plan', help_text='The plan associated with this subscription.'),
            preserve_default=False,
        ),
