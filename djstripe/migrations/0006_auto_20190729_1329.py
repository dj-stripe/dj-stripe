	...
	operations = [
		...
		migrations.CreateModel(
			...
			fields=[
				...
				('capture_method', djstripe.fields.StripeEnumField(enum=djstripe.enums.CaptureMethod, help_text='Capture method of this PaymentIntent, one of automatic or manual.', max_length=9)),
				('client_secret', models.CharField(help_text='The client secret of this PaymentIntent. Used for client-side retrieval using a publishable key.', max_length=255)),
				('confirmation_method', djstripe.fields.StripeEnumField(enum=djstripe.enums.ConfirmationMethod, help_text='Confirmation method of this PaymentIntent, one of manual or automatic.', max_length=9)),
				...
				('setup_future_usage', djstripe.fields.StripeEnumField(enum=djstripe.enums.IntentUsage, help_text='Indicates that you intend to make future payments with thisPaymentIntent’s payment method.If present, the payment method used with this PaymentIntent canbe attached to a Customer, even after the transaction completes.Use `on_session` if you intend to only reuse the payment methodwhen your customer is present in your checkout flow. Use `off_session`if your customer may or may not be in your checkout flow.Stripe uses `setup_future_usage` to dynamically optimize your payment flow andcomply with regional legislation and network rules. For example,if your customer is impacted by SCA, using `off_session` willensure that they are authenticated while processing this PaymentIntent.You will then be able to make later off-session payments for this customer.', max_length=11)),
				('shipping', djstripe.fields.JSONField(blank=True, help_text='Shipping information for this PaymentIntent.', null=True)),
				('statement_descriptor', models.CharField(blank=True, help_text='Extra information about a PaymentIntent. This will appear on your customer’s statement when this PaymentIntent succeeds in creating a charge.', max_length=255, null=True)),
				('status', djstripe.fields.StripeEnumField(enum=djstripe.enums.PaymentIntentStatus, help_text='Status of this PaymentIntent, one of requires_payment_method, requires_confirmation, requires_action, processing, requires_capture, canceled, or succeeded. You can read more about PaymentIntent statuses here.', max_length=16)),
				('transfer_data', djstripe.fields.JSONField(blank=True, help_text='The data with which to automatically create a Transfer when the payment is finalized. See the PaymentIntents Connect usage guide for details.', null=True)),
				...
				('customer', models.ForeignKey(help_text='Customer this PaymentIntent is for if one exists.', null=True, on_delete=django.db.models.deletion.CASCADE, to='djstripe.Customer')),
				('on_behalf_of', models.ForeignKey(help_text='The account (if any) for which the funds of the PaymentIntent are intended.', null=True, on_delete=django.db.models.deletion.CASCADE, to='djstripe.Account')),
			],
			options={
		...
		migrations.CreateModel(
			...
			fields=[
				...
				('type', models.CharField(blank=True, help_text='The type of the PaymentMethod. An additional hash is included on the PaymentMethodwith a name matching this value. It contains additional information specific to thePaymentMethod type.', max_length=255, null=True)),
				('customer', models.ForeignKey(blank=True, help_text='Customer to which this PaymentMethod is saved.This will not be set when the PaymentMethod has not been saved to a Customer.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payment_methods', to='djstripe.Customer')),
			],
			options={
				'get_latest_by': 'created',
				'abstract': False,
		...
		migrations.CreateModel(
			...
			fields=[
				...
				('customer', models.ForeignKey(help_text='Customer this SetupIntent belongs to, if one exists.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='djstripe.Customer')),
				...
				('payment_method', models.ForeignKey(help_text='Payment method used in this PaymentIntent.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='djstripe.PaymentMethod')),
			],
			options={
				'get_latest_by': 'created',
				'abstract': False,
		...
		migrations.CreateModel(
			...
			fields=[
				...
				('submit_type', djstripe.fields.StripeEnumField(blank=True, enum=djstripe.enums.SubmitTypeStatus, help_text='Describes the type of transaction being performed by Checkoutin order to customize relevant text on the page, such as the submit button.', max_length=6, null=True)),
				...
				('customer', models.ForeignKey(help_text='Customer this Checkout is for if one exists.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='djstripe.Customer')),
				('payment_intent', models.ForeignKey(help_text='PaymentIntent created if SKUs or line items were provided.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='djstripe.PaymentIntent')),
				('subscription', models.ForeignKey(help_text='Subscription created if one or more plans were provided.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='djstripe.Subscription')),
			],
			options={
				'get_latest_by': 'created',
				'abstract': False,
		...
		migrations.AddField(
			model_name='charge',
			name='payment_intent',
			field=models.ForeignKey(help_text='PaymentIntent associated with this charge, if one exists.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='charges', to='djstripe.PaymentIntent'),
		),
		migrations.AddField(
			model_name='invoice',
			name='payment_intent',
