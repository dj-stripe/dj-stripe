...
def check_stripe_api_key(app_configs=None, **kwargs):
    ...
    if not djstripe_settings.KEYS.STRIPE_SECRET_KEY:
        ...
        if not djstripe_settings.KEYS.LIVE_SECRET_KEY.startswith(("sk_live_", "rk_live_")):
        ...
        if not djstripe_settings.KEYS.TEST_SECRET_KEY.startswith(("sk_test_", "rk_test_")):
