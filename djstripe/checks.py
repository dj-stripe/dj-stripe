...
def check_stripe_api_key(app_configs=None, **kwargs):
    ...
    if not djstripe_settings.STRIPE_SECRET_KEY:
        ...
        msgs.append(checks.Critical(msg, hint=hint, id="djstripe.C001"))
        ...
        if not djstripe_settings.LIVE_API_KEY.startswith("sk_live_"):
            ...
            msgs.append(checks.Critical(msg, hint=hint, id="djstripe.C002"))
    else:
        if not djstripe_settings.TEST_API_KEY.startswith("sk_test_"):
            ...
            msgs.append(checks.Critical(msg, hint=hint, id="djstripe.C003"))
...
def check_stripe_api_version(app_configs=None, **kwargs):
    ...
    try:
        ...
        msgs.append(checks.Critical(six.force_text(ex), hint=hint, id="djstripe.C004"))
    ...
    if version != default_version:
        ...
        msgs.append(checks.Warning(msg, hint=hint, id="djstripe.W001"))
