...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'djstripe_customer', 'user_id')

        # Adding field 'Customer.subscriber'
        db.add_column(u'djstripe_customer', 'subscriber',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'djstripe_customer', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.SIUser'], unique=True, null=True),
                      keep_default=False)

        # Deleting field 'Customer.subscriber'
        db.delete_column(u'djstripe_customer', 'subscriber_id')
